    ...
    .tarjeta.tarjeta--azul.py-5.p-4.mb-5
      SlyderA(tipo="b").slider-a-custom(data-aos="zoom-in-left")
        .row.justify-content-center
          ...
          .col-lg-7.col-8  
            img.mb-0.mx-5(alt="tema1" src="@/assets/curso/img/img2.svg")
        ...
        .row.justify-content-center
          ...
          .col-lg-5.col-8
            img.mb-0.mx-5(alt="tema1" src="@/assets/curso/img/img3.svg")
        ...
        .row.justify-content-center
          ...
          .col-lg-5.col-8
            img.mb-0.mx-5(alt="" src="@/assets/curso/img/img4.svg")
        ...
        .row.justify-content-center
          ...
          .col-lg-5.col-8
            img.mb-0.mx-5(alt="" src="@/assets/curso/img/img6.svg")
        ...
        .row.justify-content-center
          ...
          .col-lg-5.col-8
            img.mb-0.mx-5(alt="" src="@/assets/curso/img/img5.svg")
    ...
    .row.text-left-cus.mb-4
      .col-lg-4.my-3.text-left-cus
        .bg191.bg-card.bg-img-1.d-flex.px-3.he-6-cus.flex-column
          img.w-auto-cus.bg12.mx-3(src='@/assets/curso/img/img01.jpg', alt='')
          .ml-1-custom 
            p.ml-1-custom 
      ...
      .col-lg-4.my-3.text-left-cus
        .bg191.bg-card.bg-img-1.d-flex.px-3.he-6-cus.flex-column
          img.w-auto-cus.bg12.mx-3(src='@/assets/curso/img/img02.jpg', alt='')
          .ml-1-custom 
            p.ml-1-custom 
      ...
      .col-lg-4.my-3.text-left-cus
        .bg191.bg-card.bg-img-1.d-flex.px-3.he-6-cus.flex-column
          img.w-auto-cus.bg12.mx-3(src='@/assets/curso/img/img03.jpg', alt='')
          .ml-1-custom 
            p.ml-1-custom 
