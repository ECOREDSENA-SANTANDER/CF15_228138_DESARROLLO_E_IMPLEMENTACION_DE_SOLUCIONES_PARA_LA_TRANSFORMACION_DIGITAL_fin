...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left")
      .col-lg-4.col-8.mb-5
        img.mb-lg-0.mb-3(src="@/assets/curso/img/img10.png" alt="tema2")
      .col-lg-8.col-12.mb-5
        ...
        .cajac.p-4.mb-4
          ...
          .row.d-flex.align-items-center.justify-content-center
            .col-lg-2
              img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/img/nueva.svg', alt='tema2')
    ...
    .tarjeta.tarjeta--azul.py-5.p-4.mb-5
      SlyderA(tipo="b").slider-a-custom(data-aos="zoom-in-left")
        .row.justify-content-center
          ...
          .col-lg-7.col-8  
            img.mb-0.mx-5(alt="tema1" src="@/assets/curso/img/img010.png")
        ...
        .row.justify-content-center
          ...
          .col-lg-5.col-8
            img.mb-0.mx-5(alt="tema1" src="@/assets/curso/img/img020.png")
        ...
        .row.justify-content-center
          ...
          .col-lg-5.col-8
            img.mb-0.mx-5(alt="" src="@/assets/curso/img/img030.png")
        ...
        .row.justify-content-center
          ...
          .col-lg-5.col-8
            img.mb-0.mx-5(alt="" src="@/assets/curso/img/img040.png")
        ...
        .row.justify-content-center
          ...
          .col-lg-5.col-8
            img.mb-0.mx-5(alt="" src="@/assets/curso/img/img050.png")
        ...
        .row.justify-content-center
          ...
          .col-lg-5.col-8
            img.mb-0.mx-5(alt="" src="@/assets/curso/img/img060.png")
    ...
    .row.d-flex.align-items-center.justify-content-center
      .col-sm-12.col-lg-10
        .cajaa.p-4.mb-4
          ...
          .row.d-flex.align-items-center.justify-content-center
            .col-lg-2
              img.img-a.img-t(data-aos="zoom-in")(src='@/assets/curso/img/nueva1.svg', alt='tema2')
    ...
    .row(data-aos="zoom-in")
      ...
      .col-lg-5(data-aos="fade-left")
        figure.d-lg-block.d-none
          img(src='@/assets/curso/img/img5.png', alt='imagen decorativa') 
    ...
    .row.justify-content-center.align-items-center.mb-4(data-aos="fade-left")
      .col-lg-4.col-8
        img.mb-lg-0.mb-3(src="@/assets/curso/img/img6.png" alt="")
      .col-lg-8.col-12
    ...
    SlyderF(columnas="col-lg-6 col-xl-4")
      .tarjeta.color-acento-botones.p-4
        .row.justify-content.mb-3
          .col-8
            img(src='@/assets/curso/img/ej1.svg' alt='AvatarTop')
      ...
      .tarjeta.color-acento-botones.p-4
        .row.justify-content.mb-3
          .col-8
            img(src='@/assets/curso/img/ej2.svg' alt='AvatarTop')
      ...
      .tarjeta.color-acento-botones.p-4
        .row.justify-content.mb-3
          .col-8
            img(src='@/assets/curso/img/ej3.svg' alt='AvatarTop')
      ...
      .tarjeta.color-acento-botones.p-4
        .row.justify-content.mb-3
          .col-8
            img(src='@/assets/curso/img/ej4.svg' alt='AvatarTop')
      ...
      .tarjeta.color-acento-botones.p-4
        .row.justify-content.mb-3
          .col-8
            img(src='@/assets/curso/img/ej5.svg' alt='AvatarTop')
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left")
      .col-lg-5.col-8.mb-5
        img.mb-lg-0.mb-3(src="@/assets/curso/img/img111.svg" alt="tema2")
    ...
    .row.justify-content-center.mb-5
      .col-lg-7
        ...
        img.mb-lg-0.mb-3(src="@/assets/curso/img/fig1.svg" alt="tema2")
    ...
    .row.justify-content-center.mb-5
      .col-lg-7
        ...
        img.mb-lg-0.mb-3(src="@/assets/curso/img/fig2.svg" alt="tema2")
    ...
    .row.justify-content-center.mb-5
      .col-lg-7
        ...
        img.mb-lg-0.mb-3(src="@/assets/curso/img/fig3.svg" alt="tema2")
    ...
    .row.justify-content-center.mb-5
      .col-lg-6
        ...
        img.mb-lg-0.mb-3(src="@/assets/curso/img/fig4.svg" alt="tema2")
      
      .col-lg-6.my-5
        img.mb-lg-0.mb-3(src="@/assets/curso/img/fig4.1.svg" alt="tema2")
    ...
    .row.justify-content-center.mb-5
      .col-lg-6
        ...
        img.mb-lg-0.mb-3(src="@/assets/curso/img/fig5.svg" alt="tema2")
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left")
      .col-lg-4.col-8.mb-5
        img.mb-lg-0.mb-3(src="@/assets/curso/img/img8.svg" alt="tema2")
      .col-lg-8.col-12.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left")
      ...
      .col-lg-4.col-8.mb-5
        img.mb-lg-0.mb-3(src="@/assets/curso/img/img9.svg" alt="tema2")
    ...
    .tarjeta.tarjeta--azul.py-5.p-4.mb-5
      SlyderA(tipo="b").slider-a-custom(data-aos="zoom-in-left")
        .row.justify-content-center
          ...
          .col-lg-7.col-8  
            img.mb-0.mx-5(alt="tema1" src="@/assets/curso/img/img10.svg")
        ...
        .row.justify-content-center
          ...
          .col-lg-5.col-8
            img.mb-0.mx-5(alt="tema1" src="@/assets/curso/img/img11.svg")
        ...
        .row.justify-content-center
          ...
          .col-lg-5.col-8
            img.mb-0.mx-5(alt="" src="@/assets/curso/img/img12.svg")
        ...
        .row.justify-content-center
          ...
          .col-lg-5.col-8
            img.mb-0.mx-5(alt="" src="@/assets/curso/img/img13.svg")
        ...
        .row.justify-content-center
          ...
          .col-lg-5.col-8
            img.mb-0.mx-5(alt="" src="@/assets/curso/img/img14.svg")
        ...
        .row.justify-content-center
          ...
          .col-lg-5.col-8
            img.mb-0.mx-5(alt="" src="@/assets/curso/img/img15.svg")
